...
export default definePlugin({
    ...
    descriptionTr: "Discord'u işlem adı konusunda kandırarak (discord.exe gibi görünerek) overlay'i düzeltmeye çalışır.",
                                        ...
                                        if (pProp === "getMainArgv" && typeof pValue === "function") {
                                            return (...args: any[]) => {
                                                ...
                                                if (Array.isArray(argv) && argv[0]) {
                                                    argv[0] = argv[0].replace(/Selycord\.exe/i, "discord.exe");
                                                }
                                                return argv;
                                            };
                                        }
