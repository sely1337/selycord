...
export default definePlugin({
    ...
    descriptionTr: "DM'lerinizi mesajlar, resimler, videolar, ses, bağlantılar, gömmeler, çıkartmalar ve tepkilerle birlikte TXT/JSON/CSV/MD/HTML formatında dışa aktarır.",
    authors: [{ name: "Selycord", id: 0n }],
    dependencies: ["HeaderBarAPI"],

    start() { addHeaderBarButton("Selycord-export-dm", () => <ExportButton />, 4); },
    stop() { removeHeaderBarButton("Selycord-export-dm"); },
});
