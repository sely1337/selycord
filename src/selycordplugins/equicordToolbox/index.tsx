...
export default definePlugin({
    ...
    description: "Adds a button next to the inbox button in the channel header that houses Selycord quick actions",
    descriptionTr: "Kanal başlığındaki gelen kutusu düğmesinin yanına Selycord hızlı işlemlerini barındıran bir düğme ekler.",
