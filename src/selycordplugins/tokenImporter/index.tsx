...
export default definePlugin({
    ...
    descriptionTr: "Discord tokenlarını içe aktarın ve doğrulayın.",
    authors: [{ name: "Selycord", id: 0n }],
    dependencies: ["HeaderBarAPI"],
    settings,
    start() {
        addHeaderBarButton("Selycord-token-importer", () => <TokenImporterButton />, 10);
    ...
    stop() {
        removeHeaderBarButton("Selycord-token-importer");
