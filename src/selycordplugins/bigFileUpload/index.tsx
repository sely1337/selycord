...
export default definePlugin({
    ...
    descriptionTr: "GoFile, Catbox veya özel bir yükleyici aracılığıyla Discord'un yükleme sınırını aşar. Sağ tıklama menüsünden veya /fileupload komutuyla erişilebilir.",
