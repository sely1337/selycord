...
const LS_KEY_DATA = "SelycordCP_data";
const LS_KEY_ENABLED = "SelycordCP_enabled";
const DS_ALL_DATA = "customProfile_allData";
const DS_ALL_ENABLED = "customProfile_allEnabled";
const LS_ALL_DATA = "SelycordCP_allData";
const LS_ALL_ENABLED = "SelycordCP_allEnabled";
        ...
        <ModalRoot {...rootProps} size="medium">
            ...
            <ModalContent className="cp-content">
                ...
                <div className="cp-hint">
                    ...
                    >
                        Share your Custom Profile with everyone — click to manage in Selycord Settings
                    </a>
                </div>
            </ModalContent>
