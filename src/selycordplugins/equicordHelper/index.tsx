...
export default definePlugin({
    name: "SelycordHelper",
    description: "Main Selycord plugin: fixes Discord crashes, adds UI options and manages internal commands.",
    descriptionTr: "Ana Selycord eklentisi: Discord çökmelerini düzeltir, UI seçenekleri ekler ve dahili komutları yönetir.",
    authors: [
        Devs.thororen,
        EquicordDevs.nyx,
        EquicordDevs.Naibuu,
    ...
    flux: {
        async CHANNEL_SELECT({ channelId }) {
            ...
            if (VC_SUPPORT_CHANNEL_IDS.includes(channelId) && !clicked) {
                return Alerts.show({
                    title: "Selycord Support Channel Warning",
                    body: "Before asking for help. Check updates and if this issue is actually caused by Selycord!",
                    confirmText: "Selycord Support",
                    onConfirm() {
