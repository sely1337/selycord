...
const SelycordDir = dirname(process.execPath);

export const PORTABLE =
    process.platform === "win32" &&
    !process.execPath.toLowerCase().endsWith("electron.exe") &&
    !existsSync(join(SelycordDir, "Uninstall Selycord.exe"));

export const DATA_DIR =
    process.env.Selycord_USER_DATA_DIR || (PORTABLE ? join(SelycordDir, "Data") : join(app.getPath("userData")));
...
export const USER_AGENT = `Selycord/${app.getVersion()} (https://git.${domain}/Selycord/Selycord)`;
