...
import { Card, ErrorBoundary, HeadingTertiary, Paragraph, TextButton } from "@Selycord/types/components";
import { FluxDispatcher, InviteActions } from "@Selycord/types/webpack/common";
...
function Fallback() {
    return (
        <Card variant="danger">
            ...
            <Paragraph>
                Please make sure Selycord and Selycord are fully up to date. You can get help in our{" "}
