...
import {
    ...
    RestartIcon,
    Span
} from "@Selycord/types/components";
import {
    closeModal,
    Logger,
    ModalCloseButton,
...
import { FluxDispatcher, MediaEngineStore, Select, UserStore, useState } from "@Selycord/types/webpack/common";
...
const logger = new Logger("SelycordScreenShare");
