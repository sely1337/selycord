...
import { BaseText, Button, FormSwitch } from "@Selycord/types/components";
import {
    Margins,
    ModalCloseButton,
    ModalContent,
...
import { showToast, useState } from "@Selycord/types/webpack/common";
        ...
        <section>
            ...
            <div className="vcd-user-assets-asset">
                <img
                    ...
                    src={`Selycord://assets/${asset}?v=${version}`}
                    alt=""
