...
import { useState } from "@Selycord/types/webpack/common";
    ...
    return (
        <>
            <VesktopSettingsSwitch
                ...
                description="Automatically start Selycord on computer start-up"
            ...
            <VesktopSettingsSwitch
                ...
                description={"Start Selycord minimized when starting with system"}
