...
import { Logger } from "@Selycord/types/utils";
import { findLazy, onceReady } from "@Selycord/types/webpack";
import {
    ...
    InviteActions,
    StreamerModeStore
} from "@Selycord/types/webpack/common";
import { IpcCommands } from "shared/IpcEvents";

import { onIpcCommand } from "./ipcCommands";

const logger = new Logger("SelycordRPC", "#5865f2");
