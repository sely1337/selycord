...
function patchLatest() {
    try {
        ...
        console.info("[Selycord] Detected Host Update. Repatching...");
        ...
        writeFileSync(join(app, "index.js"), "// Selycord repatch\n\"use strict\";\nconst path = require(\"path\");\nrequire(path.join(__dirname, \"..\", \"app\", \"dist\", \"desktop\", \"patcher.js\"));");
    } catch (err) {
        console.error("[Selycord] Failed to repatch latest host update", err);
    }
}
