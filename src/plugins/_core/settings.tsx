...
import { CreateThemeTab } from "@selycordplugins/createTheme/components/CreateThemeTab";
import { PencilSparkleIcon } from "@selycordplugins/createTheme/components/PencilSparkleIcon";
import IconsTab from "@selycordplugins/iconViewer/components/IconsTab";
...
const settings = definePluginSettings({
    settingsLocation: {
        ...
        description: "Where to put the Selycord settings section",
        options: [
...
export default definePlugin({
    ...
    buildLayout(originalLayoutBuilder: SettingsLayoutBuilder) {
        ...
        const equicordSection: SettingsLayoutNode = {
            ...
            useTitle: () => {
                try { if (localStorage.getItem("Selycord_stealthMode") === "1") return ""; } catch { }
                return "Selycord Settings";
            },
            buildLayout: () => {
                try { if (localStorage.getItem("Selycord_stealthMode") === "1") return [mainEntry]; } catch { }
                return fullEntries;
            }
        };
    ...
    getInfoRows() {
        ...
        const rows = [`Selycord ${gitHashShort}${getVersionInfo()}`];
