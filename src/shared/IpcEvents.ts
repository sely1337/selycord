...
export const enum IpcEvents {
    ...
    SET_WINDOW_BACKGROUND_MATERIAL = "SelycordSetWindowBackgroundMaterial",
    ...
    // Selycord Updater â€” tÃ©lÃ©charge un exe depuis une URL et le lance
    SELYCORD_DOWNLOAD_AND_RUN = "SelycordDownloadAndRun",

    // VB-Audio Virtual Cable (Windows only)
    CHECK_VB_CABLE = "SelycordCheckVBCable",
    INSTALL_VB_CABLE = "SelycordInstallVBCable",

    // Relaunch de l'app Electron
    RELAUNCH_APP = "SelycordRelaunchApp",
