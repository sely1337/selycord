# ==============================================================================
#  Selycord — Script d'injection Post-Installation
#  Utilisé par l'installateur Inno Setup pour injecter Selycord dans Discord.
# ==============================================================================
...
# On pointe vers le patcher.js dans le dossier d'installation de Selycord
$SelycordPatcher = Join-Path $AppDir "dist\desktop\patcher.js"
$SelycordPatcher = $SelycordPatcher.Replace("\", "\\")
...
// Injection Selycord
try {
    require("$SelycordPatcher");
} catch (e) {
    console.error("Selycord injection failed:", e);
    // Fallback: Discord original asar
