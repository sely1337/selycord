# ==============================================================================
#  Selycord — Désinstalleur utilisateur (PowerShell)
#  Supprime l'injection Selycord de Discord
#
...
$InstallDir    = Join-Path $env:LOCALAPPDATA "Selycord-Client"
...
Write-Host "  ║      SELYCORD — Désinstalleur           ║" -ForegroundColor Cyan
Write-Host "  ╚══════════════════════════════════════════╝" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "  │  Selycord désinstallé avec succès !                 │" -ForegroundColor Green
